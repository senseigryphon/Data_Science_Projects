...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        successes = filtered_df[filtered_df['class'] == 1].shape[0]
        failures = filtered_df[filtered_df['class'] == 0].shape[0]
        fig = px.pie(names = ['Success', 'Failure'], values = [successes, failures],
